...
typedef long long ll;typedef vector<int> vi;typedef vector<vector<int>> vvi;typedef deque<int> di;
typedef pair<int,int> pii;typedef priority_queue<int,vector<int>,greater<int>> pqgi;
